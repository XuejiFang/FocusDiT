...
class ImagePipelineOutput(BaseOutput):
    ...
    mask_all: Union[List, np.ndarray]
...
class FocusDiTPipeline(DiffusionPipeline):
    r"""
    Pipeline for text-to-image generation using FocusDiT.
    """
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred, mask_t = out
                mask_all.append(mask_t)
        ...
        return ImagePipelineOutput(images=image, mask_all=mask_all)
