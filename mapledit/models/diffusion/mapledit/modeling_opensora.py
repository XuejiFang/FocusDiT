...
from mapledit.models.diffusion.mapledit.modules import PatchEmbed2D, BasicTransformerBlock
from mapledit.utils.utils import to_2tuple


class MapleT2V(ModelMixin, ConfigMixin):
    """
...
def MapleT2V_ROPE_S_122(**kwargs):
    return MapleT2V(num_layers=28, attention_head_dim=96, num_attention_heads=16, patch_size_t=1, patch_size=2,
                       norm_type="ada_norm_single", caption_channels=768, cross_attention_dim=1536, **kwargs)

def MapleT2V_ROPE_L_122(**kwargs):
    return MapleT2V(num_layers=32, attention_head_dim=96, num_attention_heads=24, patch_size_t=1, patch_size=2,
                       norm_type="ada_norm_single", caption_channels=4096, cross_attention_dim=2304, **kwargs)

OpenSora_models = {
    "MapleT2V-ROPE-L/122": MapleT2V_ROPE_L_122,
    "MapleT2V-ROPE-S/122": MapleT2V_ROPE_S_122,
}

OpenSora_models_class = {
    "MapleT2V-ROPE-L/122": MapleT2V,
    "MapleT2V-ROPE-S/122": MapleT2V,
}
