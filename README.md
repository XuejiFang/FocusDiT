...
[Overview](#overview) · [Getting Started](#getting-started) · [Inference](#inference)
...
- **Vocabulary Redistribution.** FocusDiT allocates FFN capacity across transformer blocks with block-specific hidden widths.

This repository includes the FocusDiT model, a Mochi VAE wrapper, a text-to-image inference pipeline, and an example script that can save query-mask visualizations.
